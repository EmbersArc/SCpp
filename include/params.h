...
public:
    Matrix14d get_A(const Vector14d &x, const Vector3d &u) {
        Matrix14d A;
    ...
    Matrix14x3d get_B(const Vector14d &x, const Vector3d &u) {
        Matrix14x3d B;
    ...
    Vector14d get_f(const Vector14d &x, const Vector3d &u) {
        Vector14d f;
